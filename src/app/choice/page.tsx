...
export default function Choice() {
    ...
    useEffect(() => {
        const fetchQuestions = async () => {
            try {
                const response = await axios.get(`${process.env.NEXT_PUBLIC_API_HOST}/api/questions`);
    ...
    const handleOptionSelect = async (optionId: number) => {
        ...
        try {
            const response = await axios.post(`${process.env.NEXT_PUBLIC_API_HOST}/api/questions/${currentQuestion.id}/vote`, {
                optionId,
            });
